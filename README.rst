...
replace all instances of ``frontend-app-authenticated`` with the name of
your new repository.  Also edit index.html to replace "Authenticated Application"
...
This section concerns development of ``frontend-app-authenticated`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openedx/frontend-app-authenticated/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openedx/frontend-app-authenticated/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-authenticated
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-authenticated.svg
    :target: https://github.com/openedx/frontend-app-authenticated/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-authenticated/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-authenticated/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-authenticated/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-authenticated?branch=main
    :alt: Codecov
